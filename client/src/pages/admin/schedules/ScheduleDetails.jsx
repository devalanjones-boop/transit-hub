...
import { deleteSchedule, getScheduleById } from "../../../services/scheduleService";
...
const ScheduleDetails = () => {
    ...
    useEffect(() => {
        ...
        let fetchSchedule = async () => {
            ...
            try {
                ...
                setError(error.response?.data?.message || "Failed to load Schedule details")
    ...
    return (
        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 px-2 mb-6">
